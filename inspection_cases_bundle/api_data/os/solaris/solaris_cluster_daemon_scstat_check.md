...
[
    {id: null, key: "bad_status_keywords", value: "offline,maintenance,path down", sortOrder: 0}
,
{id: null, key: "failure_keywords", value: "장치를 찾을 수 없습니다,not found,module,cannot,command not found", sortOrder: 1}
,
{id: null, key: "required_sections", value: "Cluster Nodes,Cluster Transport Paths,Resource Groups,Network Interfaces", sortOrder: 2}
]
...
class Check(BaseCheck):
    ...
    def run(self):
        ...
        command = self._build_command(SCSTAT_COMMAND)
        rc, out, err = self._ssh(command)
        self._set_display_command(SCSTAT_COMMAND)
        ...
        hit_counts = self._count_keywordHits(all_lines, ('online', 'offline', 'maintenance', 'path down'))
