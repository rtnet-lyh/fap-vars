...
Solaris fcinfo 명령으로 HBA 포트 연결 상태와 현재 링크 속도를 점검합니다.
...
[
    {id: null, key: "expected_state_value", value: "online", sortOrder: 0}
,
{id: null, key: "min_current_speed_gbps", value: "8", sortOrder: 1}
,
...
class Check(BaseCheck):
    ...
    def run(self):
        ...
        command = self._build_command(FCINFO_HBA_PORT_COMMAND)
        rc, out, err = self._ssh(command)
        self._set_display_command(FCINFO_HBA_PORT_COMMAND)
