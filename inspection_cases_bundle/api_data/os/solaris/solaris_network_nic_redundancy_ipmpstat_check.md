...
Solaris ipmpstat 명령으로 NIC 이중화(IPMP) 상태와 인터페이스 활성 상태를 점검합니다.
...
,
{id: null, key: "expected_link_value", value: "up", sortOrder: 2}
,
{id: null, key: "expected_state_value", value: "ok", sortOrder: 3}
,
...
class Check(BaseCheck):
    ...
    def run(self):
        ...
        command = self._build_command(IPMPSTAT_INTERFACE_COMMAND)
        rc, out, err = self._ssh(command)
        self._set_display_command(IPMPSTAT_INTERFACE_COMMAND)
