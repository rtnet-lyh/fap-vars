...
[
    {id: null, key: "expected_mount_path", value: "C:\\mnt\\shared\\", sortOrder: 0}
,
{id: null, key: "expected_mode", value: "rw", sortOrder: 1}
,
    ...
    def run(self):
        ...
        if self._is_not_applicable(rc, err):
            return self.fail(
                ...
                message='Windows 클러스터 공유 볼륨 마운트 점검을 수행할 수 없습니다.',
                stdout=(out or '').strip(),
                stderr=(err or '').strip(),
            )
        ...
        return self.ok(
            ...
            message=(
                f'Windows 클러스터 공유 볼륨 마운트 점검이 정상입니다. 현재 상태: '
                f'device={device}, mount={mounted_on}, filesystem={filesystem}, mode={mode} '
                f'(기준 {expected_mode}), status={status}, health={health}.'
            ),
        )
