...
[
    {id: null, key: "cluster_bad_log_keywords", value: "status\\s+change.*offline|status\\s+change.*unknown|cluster\\s+error|communication\\s+failure|\\berror\\b", sortOrder: 0}
,
{id: null, key: "cluster_ignore_log_keywords", value: "status\\s+change.*online", sortOrder: 1}
]
