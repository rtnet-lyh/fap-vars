...
[
    {id: null, key: "nic_bad_log_keywords", value: "link\\s+down|status\\s+down|failover|lan[0-9]+.*down", sortOrder: 0}
,
{id: null, key: "nic_ignore_log_keywords", value: "link\\s+up|status\\s+up", sortOrder: 1}
]
...
BASE_COMMAND = 'dmesg'
BAD_KEY = 'nic_bad_log_keywords'
IGNORE_KEY = 'nic_ignore_log_keywords'
FAIL_ERROR = 'NIC 장애 로그 감지'
LOG_LABEL = 'NIC 장애 로그'
ITEM_LABEL = 'NIC 로그'
