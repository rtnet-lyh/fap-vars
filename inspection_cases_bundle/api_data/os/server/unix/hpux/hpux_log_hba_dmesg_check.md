...
[
    {id: null, key: "hba_bad_log_keywords", value: "loop\\s+detected|port.*offline|offline.*port|hba.*(error|fail|failed)", sortOrder: 0}
,
{id: null, key: "hba_ignore_log_keywords", value: "port.*online|online.*port", sortOrder: 1}
]
