...
[
    {id: null, key: "cpu_bad_log_keywords", value: "\\becc\\s+error\\b|\\buncorrectable\\b|cpu.*offline|offline.*cpu", sortOrder: 0}
,
{id: null, key: "cpu_ignore_log_keywords", value: "sdf", sortOrder: 1}
]
...
BASE_COMMAND = 'dmesg'
BAD_KEY = 'cpu_bad_log_keywords'
IGNORE_KEY = 'cpu_ignore_log_keywords'
FAIL_ERROR = 'CPU 장애 로그 감지'
LOG_LABEL = 'CPU 장애 로그'
ITEM_LABEL = 'CPU 로그'
