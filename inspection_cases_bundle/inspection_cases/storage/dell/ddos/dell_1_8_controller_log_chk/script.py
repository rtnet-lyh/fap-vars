...
CONFIG = {'kind': 'alert', 'commands': ['alerts show current'], 'defaults': {'device_key': 'controller_device_keywords', 'status_key': 'controller_status_keywords', 'controller_device_keywords': ['controller', 'disk controller'], 'controller_status_keywords': ['failed', 'failure', 'low', 'disabled', 'reset', 'error']}}
