...
CONFIG = {'kind': 'hba', 'commands': ['system show hardware', 'alerts show current'], 'defaults': {'keyword_key': 'hba_device_keywords', 'alert_device_key': 'hba_device_keywords', 'alert_status_key': 'hba_status_keywords', 'hba_device_keywords': ['fibrechannel', 'fc', 'hba', 'scsi target'], 'hba_status_keywords': ['offline', 'loop', 'link down']}}
