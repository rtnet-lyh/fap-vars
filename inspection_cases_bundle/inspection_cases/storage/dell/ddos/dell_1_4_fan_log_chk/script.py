...
CONFIG = {'kind': 'alert', 'commands': ['alerts show current'], 'defaults': {'device_key': 'fan_device_keywords', 'status_key': 'fan_status_keywords', 'fan_device_keywords': ['fan', 'cooling', 'thermal'], 'fan_status_keywords': ['failed', 'fault', 'offline', 'error', 'critical']}}
