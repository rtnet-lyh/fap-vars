...
CONFIG = {'kind': 'alert', 'commands': ['alerts show current'], 'defaults': {'device_key': 'power_device_keywords', 'status_key': 'power_status_keywords', 'power_device_keywords': ['power', 'psu', 'sps', 'voltage', 'power supply'], 'power_status_keywords': ['failed', 'fault', 'offline', 'error', 'critical']}}
