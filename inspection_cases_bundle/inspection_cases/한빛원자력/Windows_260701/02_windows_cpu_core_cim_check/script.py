...
CHECK_COMMAND = 'Get-CimInstance Win32_Processor | Select-Object Name,SocketDesignation,Manufacturer,MaxClockSpeed,NumberOfCores,NumberOfLogicalProcessors | Format-List'
CASE_ID = '02_windows_cpu_core_cim_check'
CHECK_NAME = 'Windows CPU 코어 상태'
THRESHOLD_DEFS = [('min_socket_count', 1, 'int'), ('min_total_core_count', 4, 'int'), ('min_total_logical_processor_count', 8, 'int'), ('failure_keywords', '', 'str')]
