...
CHECK_COMMAND = "Get-CimInstance Win32_Volume | Where-Object { $_.DriveType -eq 3 -and $_.Capacity } | Select-Object @{N='Filesystem';E={if($_.DriveLetter){$_.DriveLetter}else{$_.Name.TrimEnd('\\')}}},@{N='Size(GB)';E={[math]::Round($_.Capacity/1GB,2)}},@{N='Used(GB)';E={[math]::Round(($_.Capacity-$_.FreeSpace)/1GB,2)}},@{N='Avail(GB)';E={[math]::Round($_.FreeSpace/1GB,2)}},@{N='Use%';E={[math]::Round((($_.Capacity-$_.FreeSpace)/$_.Capacity)*100,2)}},@{N='Mounted on';E={$_.Name.TrimEnd('\\')}} | ConvertTo-Json -Depth 3"
CASE_ID = '06_windows_disk_filesystem_usage_cim_check'
CHECK_NAME = 'Windows 디스크 사용률'
THRESHOLD_DEFS = [('max_usage_percent', 80.0, 'float'), ('min_available_percent', 20.0, 'float'), ('failure_keywords', '', 'str')]
