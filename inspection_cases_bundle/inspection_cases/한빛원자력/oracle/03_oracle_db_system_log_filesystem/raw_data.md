...
# 점검 내용
Oracle 시스템 로그가 저장되는 Windows 볼륨 사용률을 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); Get-Volume | Where-Object { $_.Path -like 'C:\app\oracle\diag\rdbms\orcl\orcl\trace*' -or $_.FileSystemLabel -like '*LOG*' } | Select-Object DriveLetter, FileSystemLabel, SizeRemaining, Size
```
