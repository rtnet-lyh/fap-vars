...
# 점검 내용
MySQL 이중화/복제 상태를 Windows 환경의 DB 클라이언트 명령으로 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); mysql -NBe "SHOW REPLICA STATUS\\G"
```
