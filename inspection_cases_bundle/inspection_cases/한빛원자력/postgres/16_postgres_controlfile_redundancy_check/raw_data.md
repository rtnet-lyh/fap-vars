...
# 점검 내용
PostgreSQL 운영 필수 메타 파일의 이중화 구성을 Windows 기준으로 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); psql -Atqc "SHOW data_directory; SHOW cluster_name;" postgres
```

# 출력 결과
```text
control_files|C:\Program Files\PostgreSQL\16\data\control01.ctl;D:\DBBackup\control02.ctl
```
