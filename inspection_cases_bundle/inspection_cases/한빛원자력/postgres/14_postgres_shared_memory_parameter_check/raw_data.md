...
# 점검 내용
PostgreSQL 메모리 관련 파라미터를 Windows 운영 기준으로 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); psql -Atqc "SHOW shared_buffers; SHOW work_mem; SHOW maintenance_work_mem;" postgres
```
