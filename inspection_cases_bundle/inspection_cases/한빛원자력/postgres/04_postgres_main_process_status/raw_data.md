...
# 점검 내용
PostgreSQL Windows 서비스와 메인 프로세스 기동 상태를 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); Get-Service -Name 'postgresql-x64-16' | Select-Object Name, Status, StartType; Get-Process -Name 'postgres' -ErrorAction SilentlyContinue | Select-Object ProcessName, Id, CPU, WS
```
...
- 프로세스명: 현재값 `postgres`
- 명령어 치환 위치: `Get-Process -Name 'postgres'`
