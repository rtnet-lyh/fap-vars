...
# 점검 내용
Windows 환경에서 MSSQL 클라이언트 명령으로 실제 접속 가능 여부를 점검합니다.
...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); sqlcmd -S localhost -E -Q "SET NOCOUNT ON; SELECT 'DB is accessible';"
```
