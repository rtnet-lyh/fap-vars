...
$path = 'D:\ORATRACE'; $driveLetter = (Get-Item $path).PSDrive.Name;  Get-Volume -DriveLetter $driveLetter |
...
----------- --------------- -------------         ----
          D Data             211585667072 384973139968
```
...
# 환경별 치환 값
- `ORACLE_TRACE_PATH`: 현재값 `D:\ORATRACE`
- 명령어 치환 위치: `D:\ORATRACE`
