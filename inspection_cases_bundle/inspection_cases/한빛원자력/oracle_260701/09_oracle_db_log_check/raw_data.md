...
# 명령어
```powershell
$OutputEncoding = [System.Text.UTF8Encoding]::new($false); [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new($false); Select-String -Path 'D:\oratrace\diag\rdbms\hbdev\hbdev\trace\alert_hbdev.log' -Pattern 'ORA-|error|fatal|corrupt|deadlock|unable to extend|checkpoint not complete' -CaseSensitive:$false | Select-Object -First 20
```
...
# 임계치
- `max_error_count`: `0`
- `failure_keywords`: `ORA-,error,fatal,corrupt,deadlock`

# 판단기준
- **정상**: 심각한 오류 키워드가 확인되지 않습니다.
- **불량**: 장애 징후가 되는 오류 메시지가 확인됩니다.
