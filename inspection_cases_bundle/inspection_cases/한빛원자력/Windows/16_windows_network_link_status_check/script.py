...
CHECK_COMMAND = 'Get-NetAdapter -Physical | Select-Object Name, InterfaceDescription, Status, LinkSpeed | ConvertTo-Json -Depth 3'
CASE_ID = '16_windows_network_link_status_check'
CHECK_NAME = 'Windows 네트워크 링크 상태'
THRESHOLD_DEFS = [('min_up_physical_nic_count', 1, 'int'), ('failure_keywords', '', 'str')]
