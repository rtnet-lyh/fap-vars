...
CHECK_COMMAND = "Get-CimInstance Win32_PerfFormattedData_PerfDisk_PhysicalDisk | Where-Object { $_.Name -ne '_Total' } | Select-Object @{N='device';E={$_.Name}},@{N='r/s';E={$_.DiskReadsPerSec}},@{N='w/s';E={$_.DiskWritesPerSec}},@{N='kr/s';E={[math]::Round($_.DiskReadBytesPerSec/1KB,2)}},@{N='kw/s';E={[math]::Round($_.DiskWriteBytesPerSec/1KB,2)}},@{N='wait(ms)';E={[math]::Round($_.AvgDiskSecPerTransfer*1000,2)}},@{N='actv';E={[math]::Round($_.AvgDiskQueueLength,2)}},@{N='%b';E={[math]::Round($_.PercentDiskTime,2)}},@{N='idle%';E={[math]::Round($_.PercentIdleTime,2)}} | ConvertTo-Json -Depth 3"
CASE_ID = '10_windows_disk_io_counter_check'
CHECK_NAME = 'Windows 디스크 I/O'
THRESHOLD_DEFS = [('max_busy_percent', 80.0, 'float'), ('min_idle_percent', 20.0, 'float'), ('max_wait_ms', 10.0, 'float'), ('max_queue_length', 1.0, 'float'), ('failure_keywords', '', 'str')]
