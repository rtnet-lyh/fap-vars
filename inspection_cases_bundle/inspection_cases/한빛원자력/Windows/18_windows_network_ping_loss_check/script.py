...
CHECK_COMMAND = 'ping -n 10 ((Get-NetRoute -AddressFamily IPv4 -DestinationPrefix "0.0.0.0/0" | Sort-Object RouteMetric,InterfaceMetric | Select-Object -First 1).NextHop)'
CASE_ID = '18_windows_network_ping_loss_check'
CHECK_NAME = 'Windows 기본 게이트웨이 Ping'
THRESHOLD_DEFS = [('max_loss_percent', 0, 'int'), ('max_average_time_ms', 50, 'int'), ('failure_keywords', '', 'str')]
