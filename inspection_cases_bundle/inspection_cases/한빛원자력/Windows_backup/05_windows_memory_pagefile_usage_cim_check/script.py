...
class Check(BaseCheck):
    ...
    def execute_check(self):
        ...
        return self.ok(
            ...
            reasons=f'Windows 스왑 메모리 사용률 점검이 정상입니다. 현재 상태: 총 {swap_total_gib:.2f}GiB, 사용 {swap_used_gib:.2f}GiB, 최고 {swap_peak_gib:.2f}GiB, 사용률 {swap_usage_percent:.2f}% (기준 {max_swap_usage_percent:.2f}% 미만).',
