...
CONFIG = {'mode': 'ioscan',
 ...
 'allowed_states_key': 'allowed_processor_states',
 'expected_count_key': 'expected_cpu_count',
 'case_name': 'hpux_cpu_core_ioscan_check',
 'item_name': 'CPU 코어별 상태 점검',
 'commands': ['ioscan -fnC processor'],
 'thresholds': [{'name': 'expected_cpu_count', 'default': 0, 'type': 'int'},
                {'name': 'allowed_processor_states', 'default': 'CLAIMED', 'type': 'str'}]}
