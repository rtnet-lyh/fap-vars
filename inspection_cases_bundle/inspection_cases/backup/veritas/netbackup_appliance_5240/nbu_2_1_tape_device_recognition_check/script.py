...
class Check(BaseCheck):
    ...
    def run(self):
        ...
        if invalid_rows:
            return self.warn(metrics=metrics, thresholds=thresholds, reasons='Tape drive Status 값이 기준과 다른 행이 있습니다.', message='Tape 장치 인식 상태 경고: 비정상 drive %s개.' % len(invalid_rows))
