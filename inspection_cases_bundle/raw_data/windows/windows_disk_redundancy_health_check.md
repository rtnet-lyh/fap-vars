...
- Storage Spaces RAID가 없는 장비에서는 대상 아님으로 처리될 수 있습니다.
...
- **대상 아님**: Storage Spaces RAID 장치를 찾지 못한 일반 단일 디스크 환경입니다.
- **경고**: RAID 상태 저하, Health 이상, 실패 디스크 발생, 스페어 부족이 감지됩니다.
